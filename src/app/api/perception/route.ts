...
What do people who live here (or have lived here) actually say about it?`
    ...
    const result = {
      ...
      crimeBreakdown: crimeData ? {
        ...
        breakEnter: crimeData.breakEnter,
        theft: crimeData.theft,
        maliciousDamage: crimeData.maliciousDamage,
        drugOffences: crimeData.drugOffences,
        domesticViolence: crimeData.domesticViolence,
