...
import { Users, ThumbsUp, AlertTriangle, DollarSign, TrendingUp, Shield, Bot } from "lucide-react";
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.45 }}
        ...
        <div className="flex items-center gap-3 p-3 rounded-lg bg-white/[0.02] border border-white/[0.05]">
          ...
          <p className="text-sm text-slate-400">
            Suburb perception data not yet available for this area. AI-powered sentiment analysis coming soon.
          </p>
        </div>
      </motion.div>
    );
    ...
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.45 }}
      ...
      <div className="mt-3 flex items-center gap-2 p-2 rounded-lg bg-white/[0.02] border border-white/[0.03]">
        ...
        <p className="text-[11px] text-slate-500">
          AI sentiment analysis coming soon — will analyse Reddit, forums &amp; review sites for real-time community perception.
        </p>
      </div>
    </motion.div>
  );
