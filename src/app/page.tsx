      ...
      <main className="relative z-30 min-h-screen px-4 pt-4 pb-12 md:pb-20 pointer-events-none">
        ...
        <div className="fixed top-4 left-4 right-4 z-50 flex items-center justify-between pointer-events-auto">
          <div className="inline-flex rounded-xl p-1 gap-1 backdrop-blur-sm" style={{ background: "var(--bg-sunken)", border: "1px solid var(--border)" }}>
            <span className="flex items-center gap-1.5 px-2.5 sm:px-4 py-2 rounded-lg text-xs sm:text-sm font-medium" style={{ background: "var(--accent-subtle)", color: "var(--text-primary)" }}>
              <Search size={14} />
